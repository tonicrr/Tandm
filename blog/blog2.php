        ...
        <div id="page-wrapper">
            ...
            <header id="header_fixed" class="alt" style="background: white;">
                <div style="text-align: center; padding-top: 1rem;" >
                    <a href="../sobremi.php">
                        <h3 id="sobremimenu" style="display: inline-block; padding-right: 3rem; position: absolute; top: 2rem; right: 63rem; font-weight: normal;">Sobre mi</h3>
                    </a>
                    <a href="../servicios.php">
                        <h3 id="serviciosmenu" style="display: inline-block; padding-right: 3rem; position: absolute; top: 2rem; right: 50rem; font-weight: normal;">Servicios</h3>
                    </a>
                    <a href="../index.php">
                        <img src="../images/logo.png" alt="" style="height: 6rem; display: inline-block;" />
                    </a>
                    <a href="../blog.php">
                        <h3 id="blogmenu" style="display: inline-block; padding-left: 3rem; position: absolute; top: 2rem; right: 27rem; font-weight: normal;">Blog</h3>
                    </a>
                    <a href="../contact.php">
